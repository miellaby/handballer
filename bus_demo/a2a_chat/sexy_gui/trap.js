...
Trap.prototype.bind = function (element) {
    ...
    var self = this;
    element.onmousedown = element.ontouchstart = function (e) { return self.onMouseDown(e); }
    element.onmouseup = element.ontouchend = function (e) { return self.onMouseUp(e); }
    element.onmouseout = element.ontouchcancel = function (e) { return self.onMouseOut(e); }
...
Trap.prototype.bindTarget = function (element) {
    var self = this;
    element.onmousedown = element.ontouchstart = function (e) { self.trap(this, e); if (e.preventDefault) e.preventDefault(); else e.returnValue = false; };
    element.onselectstart = function () { return false; };
    element.unselectable = "on";
    element.style.MozUserSelect = "none";
