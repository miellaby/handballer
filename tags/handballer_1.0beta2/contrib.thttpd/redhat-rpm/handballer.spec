...
BuildRoot: /tmp/handballer-root

%description
Handballer is a slightly modified thttpd which may act as a HTTP based Pub/Sub bus. Please refer to thttpd original project for other features.
...
install  contrib/redhat-rpm/handbeller.init $RPM_BUILD_ROOT/etc/rc.d/init.d/handballer
install  contrib/redhat-rpm/handballer.conf $RPM_BUILD_ROOT/etc/
...
%post
/sbin/chkconfig --add handballer

%preun
/sbin/chkconfig --del handballer
...
%attr(0755, root, root) /etc/rc.d/init.d/handballer
%config /etc/handballer.conf
%doc /usr/man/man*/*

%changelog

* Wed Aug 22 2007 Sylvain Garden <sgarden@club.fr>
  - This file has been cloned from original thttpd.spec
